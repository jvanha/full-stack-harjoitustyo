...
const legitPawnMoves = (squareId, pieceColor, board, enPassant) => {
  console.log('enPassant, legitPawnMoves', enPassant)
  ...
  console.log('enPassant, legitPawnMoves 2', enPassant)
  console.log(pawnAttackSquares(squareId, pieceColor, board, enPassant))
  pawnAttackSquares(squareId, pieceColor, board, enPassant).forEach((squareId) => {
    console.log('enPassant', enPassant, squareId)
...
const pawnAttackSquares = (squareId, pieceColor, board) =>  {
  ...
  if (pieceColor === 'black' && squareId < 53) {
    if (squareId%8 > 0) squares.push(squareId+8-1)
    if (squareId%8 < 7) squares.push(squareId+8+1)
  }
  return squares 
}
